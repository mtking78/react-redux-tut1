...
const Stories = ({ stories, error }) =>
  <div className="stories">
    ...
    <StoriesHeader columns={COLUMNS} />
      {/* Retrieve the error object in your connect higher-order component and display with React’s conditional rendering an error message in case of an error in the state. */}
